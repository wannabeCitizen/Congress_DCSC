...
def main():
    ...
    #Changed this just to use cwd so I can delete
    ...
    if args.days:
        ...
        for day in dates:
            #This should now be the cwd that this document is in plus some folders for parsed
            print "Just got here"
            ...
            if doc_path is None:
                ...
                parse_directory(doc_path, day, interactive=args.interactive,
                                logdir=args.logdir, outdir=parsed_path)
                os.system('rm -rf {0}'.format(file_path))
